<%@ Page Title="Area Master" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="AreaMaster.aspx.cs" Inherits="SupplierData.Master.AreaMaster" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function SaveAreaData() {
            ...
            if (error.trim() != "") {
                ...
                $.ajax({
                    ...
                    data: "{Name:'" + Name + "',StateId:'" + StateId + "',Remark:'" + Remark + "',CreatedBy:'" + EmpId + "'}",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (data) {
                        if (data.d == 1) {
        ...
        function UpdateRecord(Id) {
            ...
            if (error.trim() != "") {
                ...
                $.ajax({
                    ...
                    data: "{Id: '" + Id + "',Name: '" + Name + "',StateId: '" + StateId + "',Remark: '" + Remark + "',ModifiedBy:'" + EmpId + "'}",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    global: false,
                    async: false,
        ...
        function BindTable(jsondata) {/*Function used to convert the JSON array to Html Table*/
            ...
            $.ajax({
                type: "POST",
                url: "AreaMaster.aspx/ImportInsert",
            ...
            <div id="form-layouts">
                ...
                <div class="row bg-aliceblue pdb15" id="search">
                    <form id="userregi" name="userregi">
                        ...
                        <div class="col-lg-2 col-md-4 col-sm-3 col-xs-6 mrgt7">
                            <label>Remarks</label>
                            <input type="text" id="remark" name="remark" placeholder="REMARKS" class=" form-control" required />
                        </div>
