...
namespace SupplierData.Master
{
    public partial class SupplierType : System.Web.UI.Page
    {
        ...
        [System.Web.Services.WebMethod]
        public static string SupplierTypeInsert(string Name,string CreatedBy)
        {
            string i = "";
            try
            {
        ...
        [System.Web.Services.WebMethod]
        public static string UpdateRecord(string Id, string Name,string ModifiedBy)
        {
            string i = "";
            try
            {
        ...
        public static string ImportInsert(string data,string CreatedBy)
        {
            ...
            try
            {
                ...
                {
                    cn.Open();
                    SqlCommand cmd = new SqlCommand("SL_ImportSupplierType", cn); // Procedure Call 
                    cmd.CommandType = CommandType.StoredProcedure;
