...
namespace SupplierData.Master
{
    public partial class SubCategoryMaster : System.Web.UI.Page
    {
        ...
        [System.Web.Services.WebMethod]
        public static string SubCategoryInsert(string Name,string Remark,string ImageURL, string CreatedBy)
        {
            string i = "";
            try
            {
        ...
        [System.Web.Services.WebMethod]
        public static string UpdateRecord(string Id, string Name,string Remark, string ImageURL, string  ModifiedBy)
        {
            string i = "";
            try
            {
        ...
        public static string ImportInsert(string data,string CreatedBy)
        {
            ...
            try
            {
                ...
                {
                    cn.Open();
                    SqlCommand cmd = new SqlCommand("SL_ImportSubCategory", cn); // Procedure Call 
                    cmd.CommandType = CommandType.StoredProcedure;
