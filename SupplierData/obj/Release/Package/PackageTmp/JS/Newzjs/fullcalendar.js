...
var View = FC.View = Class.extend(EmitterMixin, ListenerMixin, {
	...
	buildGotoAnchorHtml: function (gotoOptions, attrs, innerHtml) {
        //debugger;
	    var specificPrices1 = $("#calendarDataBind").text();
	    ...
	    //debugger;
		if (specificPrices1 != "") {
		    var obj = jQuery.parseJSON(specificPrices1);
		    var checkDate = date.format('YYYY-MM-DD'); //2015-12-04
		    var specificPrice;
		    if (obj[checkDate]) {
		        specificPrice = obj[checkDate].split('|')[0];
		        dealinfo = obj[checkDate].split('|')[1];
		        IsCheapest = obj[checkDate].split(',')[1];
		        if (!forceOff && this.opt('navLinks')) {
		            return '<a ' + attrs +
                        ' data-goto="' + htmlEscape(JSON.stringify(finalOptions)) + '">' +
                        innerHtml + '</br></br>' + specificPrice
		            '</a>';
		        }
		        else {
		            return '<span' + attrs + '>' +
