...
"<row ").replace(/<cols xmlns="">/g, "<cols>"); a[b] = c
    ...
    } var i = f.fn.dataTable, h = { version: "1.0.4-TableTools2", clients: {}, moviePath: "", nextId: 1, $: function (a) {
...
"is", { children: { row: l(g, "t", { text: i })} })
    ...
    }); i.ext.buttons.pdfFlash = f.extend({}, t, { className: "buttons-pdf buttons-flash", text: function (a) { return a.i18n("buttons.pdf", "PDF") }, action: function (a, b, d, c) {
        var a = c._flash, e = b.buttons.exportData(c.exportOptions), g = b.table().node().offsetWidth, f = b.columns(c.columns).indexes().map(function (a) { return b.column(a).header().offsetWidth / g }); a.setAction("pdf"); a.setFileName(r(c)); s(a, JSON.stringify({ title: r(c,
