...
$.ajax({
    ...
    data: "{Name:'" + Name + "',Address:'" + Address + "',Pincode:'" + Pincode + "',ContactPerson1:'" + ContactPerson1 + "',Mobile1:'" + Mobile1 + "',ContactPerson2:'" + ContactPerson2 + "',Mobile2:'" + Mobile2 + "',Email:'" + Email + "'}",
    contentType: "application/json; charset=utf-8",
    dataType: "json",
    success: function (data) {
        if (data.d == 1) {
         ...
         function UpdateRecord(Id) {
             ...
             if (error.trim() != "") {
                 ...
                 $.ajax({
                     ...
                     data: "{Id:'" + Id  + "',Name:'" + Name + "',Address:'" + Address + "',Pincode:'" + Pincode + "',ContactPerson1:'" + ContactPerson1 + "',Mobile1:'" + Mobile1 + "',ContactPerson2:'" + ContactPerson2 + "',Mobile2:'" + Mobile2 + "',Email:'" + EmailId + "'}",
                     contentType: "application/json; charset=utf-8",
                     dataType: "json",
                     global: false,
                     async: false,
